...
CREATE TABLE IF NOT EXISTS `brainschema`.`useraccounts` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `email_idx` (`email` ASC, `id` ASC))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `brainschema`.`userprofiles` (
  ...
  PRIMARY KEY (`id`),
  INDEX `useraccountid_idx` (`useraccountid` ASC, `id` ASC),
...
CREATE TABLE IF NOT EXISTS `brainschema`.`userratings` (
  ...
  PRIMARY KEY (`id`),
  INDEX `useraccountid_scanid_idx` (`userprofileid` ASC, `scanid` ASC),
...
CREATE TABLE IF NOT EXISTS `brainschema`.`userfeedback` (
  ...
  PRIMARY KEY (`id`),
  INDEX `userprofileid_idx` (`userprofileid` ASC, `id` ASC),
